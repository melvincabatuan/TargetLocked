package com.cabatuan.targetlocked;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    private ImageView imViewC;
    private Bitmap imageA, imageB, imageC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imViewC = (ImageView) findViewById(R.id.imageViewC);
    ...
    public native void detect(Bitmap pTarget, byte[] pSource, int pFilter);
    ...
    private Runnable DoImageProcessing = new Runnable() {
        ...
        public void run() {
            ...
            detect(imageA, videoSource, 1);
            detect(imageB, videoSource, 2);
            detect(imageC, videoSource, 3);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        try{
            ...
            imageC = Bitmap.createBitmap(size.width, size.height, Bitmap.Config.ARGB_8888);

            imViewA.setImageBitmap(imageA);
            imViewB.setImageBitmap(imageB);
            imViewC.setImageBitmap(imageC);
